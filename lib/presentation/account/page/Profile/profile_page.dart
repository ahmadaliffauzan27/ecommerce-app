import 'package:ecommerce_app/common/components/menu_tile.dart';
      ...
      body: ListView(
        children: [
          ...
          MenuTile(
            ...
            iconPath: Assets.icons.location.image().toString(),
            onTap: () {
              // Navigator.push(
              //   context,
          ...
          MenuTile(
            ...
            iconPath: Assets.icons.phone.image().toString(),
            onTap: () {
              // Navigator.push(
              //   context,
              //   MaterialPageRoute(
          ...
          MenuTile(
            title: 'Ubah Password',
            value: '•••••••••••••••••',
            iconPath: Assets.icons.password.image().toString(),
            onTap: () {
              // Navigator.push(
              //   context,
              //   MaterialPageRoute(
