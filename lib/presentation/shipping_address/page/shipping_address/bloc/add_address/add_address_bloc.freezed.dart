...
abstract class _AddAddress implements AddAddressEvent {
  const factory _AddAddress(
      ...
      required final String isDefault}) = _$AddAddressImpl;
...
mixin _$AddAddressState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AddAddressResponsesModel response) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AddAddressResponsesModel response)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({AddAddressResponsesModel response});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  final AddAddressResponsesModel response;
...
abstract class _Loaded implements AddAddressState {
  const factory _Loaded(final AddAddressResponsesModel response) = _$LoadedImpl;

  AddAddressResponsesModel get response;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
