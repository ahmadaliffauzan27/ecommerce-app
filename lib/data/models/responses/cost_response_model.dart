...
class CostResponsesModel {
  ...
  factory CostResponsesModel.fromJson(String str) =>
      CostResponsesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CostResponsesModel.fromMap(Map<String, dynamic> json) =>
      CostResponsesModel(
