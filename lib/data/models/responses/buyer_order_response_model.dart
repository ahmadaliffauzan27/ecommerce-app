...
class BuyerOrderResponsesModel {
  final List<BuyerOrder> data;
  final Meta meta;

  BuyerOrderResponsesModel({
    required this.data,
    required this.meta,
  });

  factory BuyerOrderResponsesModel.fromJson(String str) =>
      BuyerOrderResponsesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory BuyerOrderResponsesModel.fromMap(Map<String, dynamic> json) =>
      BuyerOrderResponsesModel(
