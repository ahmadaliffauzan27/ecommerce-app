...
class WaybillSuccessResponsesModel {
  final Rajaongkir rajaongkir;

  WaybillSuccessResponsesModel({
    required this.rajaongkir,
  });

  factory WaybillSuccessResponsesModel.fromJson(String str) =>
      WaybillSuccessResponsesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory WaybillSuccessResponsesModel.fromMap(Map<String, dynamic> json) =>
      WaybillSuccessResponsesModel(
