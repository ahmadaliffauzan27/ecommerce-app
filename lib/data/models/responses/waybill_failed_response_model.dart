...
class WaybillFailedResponsesModel {
  final Rajaongkir rajaongkir;

  WaybillFailedResponsesModel({
    required this.rajaongkir,
  });

  factory WaybillFailedResponsesModel.fromJson(String str) =>
      WaybillFailedResponsesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory WaybillFailedResponsesModel.fromMap(Map<String, dynamic> json) =>
      WaybillFailedResponsesModel(
